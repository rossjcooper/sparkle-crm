...
return [
     ...
     */
    'routes' => [
        'SparkleCRM' => __DIR__ . '/app/routes.php'
    ],
     ...
     */
    'panels' => [
        'SparkleCRM' => __DIR__ . '/app/panels.php'
    ],
     ...
     */
    'apis' => [
        'SparkleCRM' => __DIR__ . '/app/api.php'
    ],

    /**
     * The view paths to register.
     *
     * E.G: 'SparkleCRM' => __DIR__ . '/views'
     * can be referenced via @SparkleCRM/
     * when rendering a view in twig.
     */
    'views' => [
        'SparkleCRM' => __DIR__ . '/resources/views'
    ],
